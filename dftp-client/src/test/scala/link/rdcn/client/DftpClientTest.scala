...
import link.rdcn.client.DftpClientTest.{baseUrl, client}
...
object DftpClientTest {
  ...
  def startServer(): Unit = {
    ...
    val modules = Array(directoryDataSourceModule, new BaseDftpModule,
      new UserPasswordAuthModule(userPasswordAuthService), new PutModule, new ActionModule)
