...
import link.rdcn.ClientTestDemoProvider.authProvider
        ...
        request.getRequestURI() match {
          ...
          case otherPath =>
            ...
            if (authProvider.checkPermission(userPrincipal, otherPath)) {
              ...
              val dataFrame: DataFrame = ClientDemo2.dc.get("dftp://0.0.0.0:3102" + otherPath)
              println(s"[${System.currentTimeMillis()}] DEBUG: Server A - ready to sendDataFrame.")
