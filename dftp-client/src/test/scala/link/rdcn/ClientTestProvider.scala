...
trait ClientTestProvider {

}

object ClientTestProvider {
  ConfigLoader.init()
  ...
  //必须在DfInfos前执行一次
  ClientTestDataGenerator.generateTestData(binDir, csvDir, baseDir)
  ...
  def stop(): Unit = {
    ...
    ClientTestDataGenerator.cleanupTestData(baseDir)
  }
