...
import link.rdcn.server.{Anchor, DacpGetBlobStreamRequest, DftpGetPathStreamRequest, DftpGetStreamRequest, DftpModule, DftpRequest, DftpResponse, GetStreamRequestParseService, LogService, ServerContext}
...
class BaseDftpModule extends DftpModule {
  override def init(anchor: Anchor, serverContext: ServerContext): Unit = {
    //by default using a file based access logger
    ...
    anchor.hook(new GetStreamRequestParseService {
