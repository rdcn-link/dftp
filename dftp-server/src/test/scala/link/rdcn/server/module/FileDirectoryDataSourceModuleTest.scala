...
//
//class FileDirectoryDataSourceModuleTest {
//
//  // JUnit 5 会为每个测试注入一个唯一的临时目录
//  @TempDir
//  var tempDir: File = _
//
//  private var moduleToTest: FileDirectoryDataSourceModule = _
...
//    moduleToTest = new FileDirectoryDataSourceModule()
//
//    // 4. 关键：将被测模块指向我们的临时目录
...
//
//    // 验证 getDataFrame()
//    val resultDF = chainedService.getDataFrame(testUrl, MockUserPrincipalForDirectory)
//
...
//      chainedService.getDataFrame(testUrl, MockUserPrincipalForDirectory)
//      ()
...
//
//    // 验证 DFRef
//    val expectedRefUrl = "dftp://mock-host:1234/subdir/nested.txt"
