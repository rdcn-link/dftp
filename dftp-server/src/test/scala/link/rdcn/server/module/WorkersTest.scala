...
//import link.rdcn.server.{,DftpGetStreamRequest, DftpGetStreamResponse}
...
//class WorkersTest {
//
//  class MockDftpGetPathStreamRequest(path: String) extends DftpGetStreamRequest {
//
...
//      request match {
//        case r: DftpGetStreamRequest => {
//          if (r.getTicket.contains("@forbidden")) {
