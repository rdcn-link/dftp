...
//import link.rdcn.user.{AuthenticationRequest, AuthenticationService, Credentials, UserPrincipalWithCredentials}
...
//  private var mockAuthModule: MockAuthModule = null
...
//  @BeforeAll
//  def setUp(): Unit = {
//    mockAuthModule = new MockAuthModule()
//    mockAnchor = new MockAnchor()
//    // 执行 init，这会触发 hook
//    mockAuthModule.init(mockAnchor, mockContext)
//    try {
...
//
//    assertTrue(service.accepts(new AuthenticationRequest {
//      override def getCredentials: Credentials = testCreds
//    }), "accepts 应该总是返回 true")
//  }
//
//  /**
...
//
//  override def getProtocolScheme(): String = ???
//
//  override def getDftpHome(): Option[String] = ???
//}