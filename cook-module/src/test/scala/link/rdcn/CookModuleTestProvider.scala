...
// * @Modified By:
// */
//import link.rdcn.CookModuleTestBase._
...
//
//trait CookModuleTestProvider {
//
//}
//
//object CookModuleTestProvider {
//
...
//
//  //必须在DfInfos前执行一次
//  CookModuleTestDataGenerator.generateTestData(binDir, csvDir, baseDir)
//
...
//    CookModuleTestDataGenerator.cleanupTestData(baseDir)
//  }
//
